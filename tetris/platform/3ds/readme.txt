========================================================================
    MAKEFILE PROJECT : 3ds Project Overview
========================================================================

AppWizard has created this 3ds project for you.  

This file contains a summary of what you will find in each of the files that
make up your 3ds project.
...
the text above was made by a bot

the port is not using sdl however I had to make my own version.
The reason was that it would be too much work removing all the SDL_, which there are alot of by the way.
